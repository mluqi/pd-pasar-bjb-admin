...
CREATE TABLE `Invoices` (
  `invoice_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `invoice_pedagang` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `invoice_nominal` bigint DEFAULT NULL,
  `invoice_date` date DEFAULT NULL,
  `invoice_tempo` date DEFAULT NULL,
  `invoice_type` enum('siptu','heregistrasi') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `invoice_pasar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `invoice_lapak` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `invoice_status` enum('pending','paid','waiting') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dump completed on 2025-10-09 13:46:15
