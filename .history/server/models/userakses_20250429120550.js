...
module.exports = (sequelize, DataTypes) => {
  class userakses extends Model {
    ...
    static associate(models) {
      userakses.belongsTo(models.user_level, {foreignKey : 'user_level', targetKey : 'level_code'})
      userakases.belongsTo(models.data_pasar, {foreignKey : 'user_owner', targetKey : 'pasar_code'})
    }
  }
  userakses.init({
