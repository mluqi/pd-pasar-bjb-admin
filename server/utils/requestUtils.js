function getClientIp(req) {
    ...
    return forwarded ? forwarded.split(',')[0] : req.connection.remoteAddress || 'IP tidak dikenali';
  }
  ...
  function getClientBrowser(userAgent) {
    ...
    else if (userAgent.includes('MSIE') || userAgent.includes('Trident')) return 'Internet Explorer';
